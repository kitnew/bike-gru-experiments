% !TeX encoding=utf-8
\documentclass[a4paper]{systemovaPrirucka}
...
% druha moznost cez BibTeX - literatutu vkladajte do literatura_sp.bib
\bibliographystyle{plain}
\bibliography{literatura_sp}
\newpage
\end{document}
